...
public class viewTasks extends JFrame{
    ...
    public viewTasks(){
        ...
        String columns[] ={ "TaskID","Task Name", "Task Description", "Department","Supervisor", "Equipment", "Status", "Deadline"};
        ...
        ///buttons
        JButton view=new JButton("Show Tasks");
